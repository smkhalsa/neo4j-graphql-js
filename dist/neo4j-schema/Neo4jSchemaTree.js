        ...
        value: function _populate(nodeTypes, relTypes) {
          ...
          _lodash['default']
            ...
            .forEach(function(nodeType) {
              ...
              var labelCombos = _lodash['default'].uniq(
              ...
              labelCombos.forEach(function(item) {
                ...
                var id = combo.join(':');
                var entity =
                  _this3.nodes[id] || new _entities['default'].Neo4jNode(id);
                ...
                nodeTypes
                  ...
                  .forEach(function(propDetail) {
                    ...
                    propDetail.graphQLType = _types[
                      'default'
                    ].chooseGraphQLType(propDetail);
          ...
          _lodash['default']
            ...
            .forEach(function(relType) {
              ...
              var entity =
                _this3.rels[id] ||
                new _entities['default'].Neo4jRelationship(id);
              ...
              relTypes
                ...
                .forEach(function(propDetail) {
                  ...
                  propDetail.graphQLType = _types['default'].chooseGraphQLType(
                    propDetail
                  );
                  entity.addProperty(propDetail.propertyName, propDetail);
                });
