    ...
    (0, _createClass2['default'])(Neo4jSchemaEntity, [
      ...
      },
      {
        ...
        value: function addProperty(name, details) {
          if (
            _lodash['default'].isNil(name) ||
            _lodash['default'].isNil(details)
          ) {
  ...
  (function(_Neo4jSchemaEntity) {
    ...
    function Neo4jNode(id) {
      ...
      return (0, _possibleConstructorReturn2['default'])(
        this,
        (0, _getPrototypeOf2['default'])(Neo4jNode).call(this, id, 'node', {})
      );
    }
...
var Neo4jRelationship =
  ...
  (function(_Neo4jSchemaEntity2) {
    ...
    function Neo4jRelationship(id) {
      ...
      return (0, _possibleConstructorReturn2['default'])(
        this,
        (0, _getPrototypeOf2['default'])(Neo4jRelationship).call(
          this,
          id,
          'relationship',
          {}
    ...
    (0, _createClass2['default'])(Neo4jRelationship, [
      ...
      },
      {
        ...
        value: function isUnivalent() {
          return (
            this.links && this.links.length === 1 // Length of links[0].from and to doesn't matter, as label combinations may be in use.
          );
        }
      },
      {
      ...
      },
      {
        ...
        value: function _setify(thing) {
          return new _set['default'](
            _lodash['default'].isArray(thing) ? thing : [thing]
          );
        }
      },
      {
        ...
        value: function _setIntersection(a, b) {
          return new _set['default'](
            (0, _toConsumableArray2['default'])(a).filter(function(x) {
              return b.has(x);
            })
          );
        }
      ...
      },
      {
        ...
        value: function isOutboundFrom(label) {
          ...
          var linksFromThisLabelSet = this.links.filter(function(link) {
            ...
            var intersection = _this2._setIntersection(
              comparisonSet,
              hereFromSet
            );
