...
function buildCypherSelection(_ref) {
  ...
  var recurse = function recurse(args) {
    ...
    return [
      subSelection,
      _objectSpread({}, shallowFilterParams, {}, subFilterParams)
    ];
  };

  if (
    selections.find(function(_ref4) {
      var kind = _ref4.kind;
    ...
    return selections
      ...
      .reduce(function(query, selection, index) {
        var fragmentSelections = selections
          .filter(function(_ref6) {
            var kind = _ref6.kind;
            return kind && kind !== 'InlineFragment';
          })
          .concat(selection.selectionSet.selections);
        var fragmentSchemaType = resolveInfo.schema.getType(
